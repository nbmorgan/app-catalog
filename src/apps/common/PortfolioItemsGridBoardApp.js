(function () {
    ...
    Ext.define('Rally.apps.common.PortfolioItemsGridBoardApp', {
        ...
        initComponent: function(){
            ...
            if (this.getContext().isFeatureEnabled('S98593_ENABLE_NEW_FILTERING_AND_SHARED_VIEWS_ON_PORTFOLIO_ITEMS_AND_KANBAN')) {
                this.addNewConfig.margin = 0;
            }
        },
        ...
        getGridBoardCustomFilterControlConfig: function () {
            ...
            if (context.isFeatureEnabled('S98593_ENABLE_NEW_FILTERING_AND_SHARED_VIEWS_ON_PORTFOLIO_ITEMS_AND_KANBAN')) {
                return {
