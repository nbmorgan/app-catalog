...
describe 'Rally.apps.common.PortfolioItemsGridBoardApp', ->
  ...
  describe 'filtering panel plugin', ->
    ...
    it 'should use rallygridboard filtering plugin', ->
      @stubFeatureToggle ['S98593_ENABLE_NEW_FILTERING_AND_SHARED_VIEWS_ON_PORTFOLIO_ITEMS_AND_KANBAN'], true
      @renderApp().then =>
  ...
  describe 'shared view plugin', ->
    ...
    it 'should enableGridEditing when S91174_ISP_SHARED_VIEWS_MAKE_PREFERENCE_NAMES_UPDATABLE is true', ->
      @stubFeatureToggle ['S91174_ISP_SHARED_VIEWS_MAKE_PREFERENCE_NAMES_UPDATABLE', 'S98593_ENABLE_NEW_FILTERING_AND_SHARED_VIEWS_ON_PORTFOLIO_ITEMS_AND_KANBAN'], true
      @renderApp().then =>
    ...
    it 'should NOT enableGridEditing when S91174_ISP_SHARED_VIEWS_MAKE_PREFERENCE_NAMES_UPDATABLE is false', ->
      ...
      isFeatureEnabledStub.withArgs('S98593_ENABLE_NEW_FILTERING_AND_SHARED_VIEWS_ON_PORTFOLIO_ITEMS_AND_KANBAN').returns true
      @renderApp().then =>
